...
class SchedulerOutputProcessorMixin:
    ...
    def DispatchLoadTasks(self, prefetch_step: Optional[int] = None):
        self.tree_cache.cache_controller._clear_outdated_operations(0)
            ...
            for step in range(0, p_step+1):
                ...
                for agent_id in agent_ids:
                    ...
                    if self.server_args.disable_lr_pf is not True:
                        ...
                        if not to_break:
                            self.prefetch_agent.add(lora_name)
                        else:
                            to_break = True
                            break
